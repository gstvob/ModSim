...
int TestWhile::main(int argc, char** argv) {
    ...
    Assign::Assignment* assign1Assignment = new Assign::Assignment(Assign::DestinationType::Variable, "test", "0");
    ...
    Assign::Assignment* assign2Assignment = new Assign::Assignment(Assign::DestinationType::Variable, "test", "test + 1");
    assign2->getAssignments()->insert(assign2Assignment);
    components->insert(assign2);
    //
    Dispose* dispose1 = new Dispose(model);
    components->insert(dispose1);
    while2->attach_loop_end(dispose1);
    //
