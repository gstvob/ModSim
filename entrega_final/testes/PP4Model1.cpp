...
int PP4Model1::main(int argc, char** argv) {
    ...
    */
    ...
    Assign::Assignment* pageNumberAtt = new Assign::Assignment(Assign::DestinationType::Attribute, "PageNumber", "TRUNC(UNIF(1,ROUND(MemorySize/PageSize)))"); 
    ...
    */
    ...
    Assign::Assignment* pegarPaginaAleatoriaAssignment = new Assign::Assignment(Assign::DestinationType::Attribute, "PageNumber", "TRUNC(UNIF(1,ROUND(MemorySize/PageSize)))");
    ...
    hold1->setQueueName("HoldProcessMMUQueue");
    ...
    hold2->setQueueName("HoldSuspendedQueue");
...
/*    searchTLB->setType(2);
    ...
    */
    ...
    Assign::Assignment* updatePageTableAssignment = new Assign::Assignment(Assign::DestinationType::Variable, "PageTables", "PageTables + 1", "pid * PageNumber","1");
    ...
    */
    ...
    Decide* while_mock = new Decide(model);
    while_mock->getConditions()->insert("TLBi <= ROUND(ROUND(MemorySize/PageSize) * 0.1) and BreakLoop==0");
    components->insert(while_mock);
    /*
    ...
    */
    ...
    tlbRowNotEmpty->getConditions()->insert("pid > 0");
    ...
    decideMenor->getConditions()->insert("TLBi < TLBmin"); 
    ...
    //while1->attach_loop_end(replaceTLBEntry);
    ...
    initLoop->getNextComponents()->insert(while_mock);
    while_mock->getNextComponents()->insert(tlbRowNotEmpty);
    tlbRowNotEmpty->getNextComponents()->insert(decideMenor);
    tlbRowNotEmpty->getNextComponents()->insert(breakA);
    breakA->getNextComponents()->insert(while_mock);
    ...
    incTLBi->getNextComponents()->insert(while_mock);
    while_mock->getNextComponents()->insert(replaceTLBEntry);
    ...
    */
    ...
    Decide* while_mock2 = new Decide(model);
    while_mock2->getConditions()->insert("MEMi <= ROUND(MemorySize/PageSize)");
    //while_mock2->getConditions()->insert("MEMi <= PageCount && BreakLoop == 0");
    components->insert(while_mock2);
    /*
    ...
    */
    ...
    frameBufferNotEmpty->getConditions()->insert("MEMi > 0");
    ...
    decideUpdateMemtoremove->getConditions()->insert("pid < 1");
//    decideUpdateMemtoremove->getConditions()->insert("PageTables[MainMemory[MEMi,1]*MainMemory[MEMi,2],1] <  PageTables[MainMemory[MemToRemove,1]*MainMemory[MemToRemove,2],1]");
    ...
    */
    ...
    //while2->attach_loop_end(signalSuspendProcess);
    ...
    memToRemoveEmpty->getConditions()->insert("MemToRemove == 0");
//    memToRemoveEmpty->getConditions()->insert("MainMemory [MemToRemove,1] == 0");
    ...
    Assign::Assignment* clearPageTableEntryAssignment1 = new Assign::Assignment(Assign::DestinationType::Variable, "PageTables", "0", "MainMemory [MemToRemove,1] * MainMemory [MemToRemove,2]", "1"); // AQUELES VAR LOCO
    Assign::Assignment* clearPageTableEntryAssignment2 = new Assign::Assignment(Assign::DestinationType::Variable, "PageTables", "0", "MainMemory [MemToRemove,1] * MainMemory [MemToRemove,2]", "2");
    ...
    initLoopM->getNextComponents()->insert(while_mock2);
    while_mock2->getNextComponents()->insert(frameBufferNotEmpty);
    ...
    breakLoopA->getNextComponents()->insert(while_mock2);
    ...
    memI->getNextComponents()->insert(while_mock2);
    while_mock2->getNextComponents()->insert(signalSuspendProcess);
    ...
    signalResumeProcess->getNextComponents()->insert(updTLB);
